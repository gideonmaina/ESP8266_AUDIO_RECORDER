...
int main() {
    ...
    int data_size=postAudioPosition - preAudioPosition;
    std::cout<<"Audio Data Size 2: "<<data_size<<std::endl;
    writeToFile(audioFile, data_size , 4);
